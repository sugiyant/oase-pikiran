  ...
  for (const art of articles) {
    ...
    try {
      ...
      const newContent = await generateText(`
        ...
        Ensure it matches the academic, wise, and highly reflective tone of Oase Pikiran.
      ...
      execSync(`npx wrangler d1 execute oase-pikiran-db --remote --file="${tempFile}"`, { stdio: 'ignore' });
